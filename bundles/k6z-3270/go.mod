module github.com/msradam/k6-z/bundles/k6z-3270

go 1.25.2

require (
	github.com/grafana/xk6-exec v0.5.1
	github.com/grafana/xk6-ssh v0.1.4
	github.com/msradam/xk6-tn3270 v0.1.0
	go.k6.io/k6 v1.6.1
)
